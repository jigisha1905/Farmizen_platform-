...
// ── MOCK DATA ──
let allStays = [
  { id:1,  name:'Peaceful Valley Farm Stay',      type:'Farm House',  bedrooms:3, guests:8, price:3500, location:'Jaipur, Rajasthan',      icon:'🏡', desc:'Spacious farmhouse with garden and farmland views.', amenities:['WiFi','Kitchen','AC','Hot Water','Garden'], activities:['Farm Tour','Cooking','Photography'], rating:4.8, reviews:240, phone:'9876543210' },
  { id:2,  name:'Riverside Farm Cottage',          type:'Cottage',     bedrooms:2, guests:4, price:2500, location:'Chittorgarh, Rajasthan', icon:'🏘️', desc:'Cozy cottage with river views and organic gardens.', amenities:['WiFi','Kitchen','Hot Water','Pool'], activities:['Farm Tour','Yoga','Stargazing'], rating:4.6, reviews:180, phone:'9812345678' },
  { id:3,  name:'Green Valley Eco Farm',           type:'Farm House',  bedrooms:4, guests:10, price:4500, location:'Udaipur, Rajasthan', icon:'🌾', desc:'Eco-friendly farmhouse with sustainability practices.', amenities:['WiFi','Kitchen','AC','Garden','Parking'], activities:['Farm Tour','Cooking','Photography','Yoga'], rating:4.9, reviews:320, phone:'9865432101' },
  { id:4,  name:'Mountain View Farm Hut',          type:'Hut',         bedrooms:1, guests:2, price:1500, location:'Ajmer, Rajasthan', icon:'⛰️', desc:'Rustic hut with mountain views and simple living.', amenities:['Kitchen','Hot Water','Garden'], activities:['Stargazing','Photography','Farm Tour'], rating:4.7, reviews:150, phone:'9765432109' },
  { id:5,  name:'Mango Orchard Farm Stay',         type:'Farm House',  bedrooms:3, guests:6, price:3000, location:'Sikar, Rajasthan', icon:'🥭', desc:'Stay among mango trees with homemade organic food.', amenities:['WiFi','Kitchen','Hot Water','Garden','Bonfire'], activities:['Farm Tour','Cooking','Horse Riding'], rating:4.8, reviews:210, phone:'9823456789' },
  { id:6,  name:'Desert Camp Experience',          type:'Camp Site',   bedrooms:0, guests:8, price:2000, location:'Bikaner, Rajasthan', icon:'⛺', desc:'Glamping under stars with farm activities.', amenities:['Bonfire'], activities:['Stargazing','Horse Riding','Photography'], rating:4.5, reviews:120, phone:'9898765432' },
  { id:7,  name:'Village Retreat Farm Cottage',   type:'Cottage',     bedrooms:2, guests:5, price:2800, location:'Kota, Rajasthan', icon:'🏘️', desc:'Traditional village-style cottage with local culture.', amenities:['WiFi','Kitchen','AC','Hot Water','Parking'], activities:['Farm Tour','Cooking','Photography','Yoga'], rating:4.7, reviews:190, phone:'9898001234' },
  { id:8,  name:'Organic Farm Villa',              type:'Farm House',  bedrooms:5, guests:12, price:5500, location:'Nagaur, Rajasthan', icon:'🏛️', desc:'Luxury farmhouse with all modern amenities.', amenities:['WiFi','Kitchen','AC','Hot Water','Pool','Garden','Parking','Bonfire'], activities:['Farm Tour','Cooking','Horse Riding','Photography','Yoga'], rating:4.9, reviews:380, phone:'9812309876' },
];
