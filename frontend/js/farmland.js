...
let allLand = [
  { id:1,  title:'Fertile Agricultural Land',       type:'Agricultural',  listingType:'Sale',  size:5,   sizeUnit:'acres',   price:2500000, priceUnit:'total',    location:'Jaipur, Rajasthan',      pincode:'302001', phone:'8107161922', owner:'Ramesh Sharma',  features:['Water Source','Road Access','Electricity'], desc:'Well-irrigated land with canal water access. Suitable for wheat and mustard cultivation.' },
  { id:2,  title:'Mango Orchard for Lease',         type:'Horticultural', listingType:'Lease', size:3,   sizeUnit:'acres',   price:15000,   priceUnit:'per year', location:'Chittorgarh, Rajasthan', pincode:'312001', phone:'8107161922', owner:'Prakash Mali',   features:['Water Source','Fencing','Road Access'],     desc:'Established mango orchard with 120+ trees. Ready for immediate farming.' },
  { id:3,  title:'Organic Certified Farm',          type:'Organic Farm',  listingType:'Sale',  size:8,   sizeUnit:'acres',   price:4800000, priceUnit:'total',    location:'Ajmer, Rajasthan',       pincode:'305001', phone:'8107161922', owner:'Gita Bai',       features:['Water Source','Tube Well','Electricity','Fencing'], desc:'NPOP certified organic farm. Rich black soil with borewell irrigation.' },
  { id:4,  title:'Grazing Land Available',          type:'Grazing Land',  listingType:'Lease', size:12,  sizeUnit:'acres',   price:8000,    priceUnit:'per year', location:'Bikaner, Rajasthan',     pincode:'334001', phone:'8107161922', owner:'Abdul Karim',    features:['Road Access'],                              desc:'Open grazing land ideal for cattle and goat farming.' },
  { id:5,  title:'Mixed Use Agricultural Plot',     type:'Mixed Use',     listingType:'Sale',  size:2.5, sizeUnit:'acres',   price:1800000, priceUnit:'total',    location:'Sikar, Rajasthan',       pincode:'332001', phone:'8107161922', owner:'Sunita Devi',    features:['Water Source','Road Access','Storage'],     desc:'Versatile land suitable for vegetables, fruits and small poultry.' },
  { id:6,  title:'Horticultural Land with Borewell',type:'Horticultural', listingType:'Sale',  size:4,   sizeUnit:'acres',   price:3200000, priceUnit:'total',    location:'Kota, Rajasthan',        pincode:'324001', phone:'8107161922', owner:'Poonam Jain',    features:['Tube Well','Road Access','Electricity'],    desc:'Suitable for citrus and guava plantation. Existing borewell with motor.' },
  { id:7,  title:'Wheat Farm on Lease',             type:'Agricultural',  listingType:'Lease', size:6,   sizeUnit:'acres',   price:12000,   priceUnit:'per year', location:'Nagaur, Rajasthan',      pincode:'341001', phone:'8107161922', owner:'Suresh Patel',   features:['Water Source','Road Access'],               desc:'Productive land for wheat and pulses. Canal irrigation available.' },
  { id:8,  title:'Small Organic Plot',              type:'Organic Farm',  listingType:'Lease', size:1,   sizeUnit:'acres',   price:6000,    priceUnit:'per year', location:'Jodhpur, Rajasthan',     pincode:'342001', phone:'8107161922', owner:'Vimla Sharma',   features:['Water Source','Fencing','Electricity'],     desc:'Perfect for beginners. Small plot with basic infrastructure ready.' },
];
